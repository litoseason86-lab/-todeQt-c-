...
| 032 | 给数据库连接设置 busy_timeout，导出期间主线程写入不再瞬间失败 | P1 | S | — | TODO |
| 033 | 导出进行中挡住退出与关窗，把 exportService.busy 接进界面 | P1 | S | — | TODO |
| 034 | 44 个 QML 测试拆成独立 ctest 条目，让 `ctest -j` 真正并行 | P2 | S | — | TODO |
