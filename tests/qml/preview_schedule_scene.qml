...
// 用用户真实的 9 条课表数据、按真实窗口尺寸渲染待办页，落盘后人工核对版式。
...
Rectangle {
    ...
    QtObject {
        ...
        // 注意这个桩不做周次过滤，getEntriesForWeek 一律返回全部——走查要的是
        // 「版式在最满的一周装不装得下」，过滤掉反而看不到最挤的情形。
        // 真实服务会按 week_start/week_end 与单双周筛选（第 1 周实际只有 6 项）。
        property var allEntries: [
            { id: 1, title: "Android应用开发技术", location: "A1214 朱银龙", weekday: 1,
              startMinutes: 960, endMinutes: 1060, durationMinutes: 100,
              weekStart: 2, weekEnd: 8, weekParity: 0,
              categoryId: undefined, categoryName: "", categoryColor: "" },
            { id: 2, title: "Java EE框架技术", location: "A1210 孙露露", weekday: 2,
              startMinutes: 480, endMinutes: 580, durationMinutes: 100,
              weekStart: 1, weekEnd: 8, weekParity: 0,
              categoryId: undefined, categoryName: "", categoryColor: "" },
            { id: 3, title: "人工智能", location: "A1208 张梦园", weekday: 2,
              startMinutes: 600, endMinutes: 700, durationMinutes: 100,
              weekStart: 1, weekEnd: 8, weekParity: 0,
              categoryId: undefined, categoryName: "", categoryColor: "" },
            { id: 4, title: "信息系统分析与设计", location: "A1教学楼A1514 程蓓蓓", weekday: 2,
              startMinutes: 840, endMinutes: 940, durationMinutes: 100,
              weekStart: 1, weekEnd: 8, weekParity: 0,
              categoryId: undefined, categoryName: "", categoryColor: "" },
            { id: 5, title: "Android应用开发技术", location: "图书馆402 朱银龙", weekday: 2,
              startMinutes: 960, endMinutes: 1060, durationMinutes: 100,
              weekStart: 2, weekEnd: 8, weekParity: 0,
              categoryId: undefined, categoryName: "", categoryColor: "" },
            { id: 6, title: "人工智能", location: "实验楼404 张梦园", weekday: 3,
              startMinutes: 960, endMinutes: 1060, durationMinutes: 100,
              weekStart: 1, weekEnd: 8, weekParity: 0,
              categoryId: undefined, categoryName: "", categoryColor: "" },
            { id: 7, title: "Java EE框架技术", location: "图书馆302 孙露露", weekday: 4,
              startMinutes: 600, endMinutes: 700, durationMinutes: 100,
            ...
            { id: 8, title: "信息系统分析与设计", location: "图书馆402 程蓓蓓", weekday: 4,
              ...
              weekStart: 1, weekEnd: 8, weekParity: 0,
              categoryId: undefined, categoryName: "", categoryColor: "" },
            { id: 9, title: "Android应用开发技术", location: "图书馆501 朱银龙", weekday: 5,
              startMinutes: 840, endMinutes: 940, durationMinutes: 100,
              weekStart: 2, weekEnd: 8, weekParity: 0,
              categoryId: undefined, categoryName: "", categoryColor: "" }
        ]
