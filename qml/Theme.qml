    ...
    readonly property var themes: [
        {
            ...
            base: "#f3e3cf",
            surface: "#fdf6e8", surfaceRaised: "#faefdb", surfaceSunken: "#f5e5cc",
            border: "#e7cfa8", borderSubtle: "#f0dfc0",
            ...
            glassSidebar: Qt.rgba(253 / 255, 246 / 255, 232 / 255, 0.68),
            glassCard: Qt.rgba(254 / 255, 248 / 255, 238 / 255, 0.85),
            glassDialog: Qt.rgba(254 / 255, 248 / 255, 238 / 255, 0.985),
        ...
        },
        {
            ...
            base: "#efc4d0",
            surface: "#fdf1f5", surfaceRaised: "#fbe7ee", surfaceSunken: "#f7dde6",
            border: "#eec1d2", borderSubtle: "#f5d8e2",
            ...
            glassSidebar: Qt.rgba(253 / 255, 235 / 255, 241 / 255, 0.68),
            glassCard: Qt.rgba(254 / 255, 244 / 255, 248 / 255, 0.85),
            glassDialog: Qt.rgba(254 / 255, 244 / 255, 248 / 255, 0.985),
            glassBorder: Qt.rgba(1, 1, 1, 0.85),
        ...
        },
        {
            ...
            base: "#dfe8e2",
            surface: "#f2f8f4", surfaceRaised: "#e9f3ed", surfaceSunken: "#dfece5",
            border: "#bcd6c9", borderSubtle: "#d3e4da",
            ...
            glassSidebar: Qt.rgba(239 / 255, 247 / 255, 242 / 255, 0.68),
            glassCard: Qt.rgba(245 / 255, 251 / 255, 248 / 255, 0.85),
            glassDialog: Qt.rgba(245 / 255, 251 / 255, 248 / 255, 0.985),
            glassBorder: Qt.rgba(1, 1, 1, 0.85),
